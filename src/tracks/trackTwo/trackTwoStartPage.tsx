...
export default function TrackOne() {
  ...
  return (
    ...
    >
      ...
      <div className="h-full w-full flex items-center justify-center gap-[2vw] px-[4vw]">
        <div
        ...
        >
          <div className="relative w-fit -translate-x-[1vw]">
            <img
              src={trackTwoImage}
              alt="Track One"
        ...
        <div className="relative z-30 w-[42vw] min-h-[320px]">
          ...
          >
            <div className="relative w-[min(34vw,400px)]">
              ...
              <TrackDescriptionBox
                trackNumber={2}
                description={track2.trackDescriptionDetailPage}
